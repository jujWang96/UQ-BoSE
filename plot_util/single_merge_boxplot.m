...
function ax = single_merge_boxplot(ax, metrics, gridsizes,qt,color, offset,LineStyle,Marker,linename)
...
for i =1:K
    boxplot(metrics(i,:), 'positions', i+offset(i),'Color',color,'OutlierSize',4);
end