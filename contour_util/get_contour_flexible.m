function [contour,N] = get_contour_flexible(n, DT,selected,adj_mat,invalid,cell_area)

% Get the contour of segmentations, handeling edge case of get_contour.m
%Input: 
%
% n: number of points 
% DT: a Delaunay triangulation object
% selected: the segmentation 
% choose
