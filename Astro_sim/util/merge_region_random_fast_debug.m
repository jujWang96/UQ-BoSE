function [sets_all, log_like_all] = merge_region_random_fast_debug(num_region, region_area, ...
    region_intensity, region_sets, adj_mat_region, region_num_cells, n, rand_num, seed,DT,cx, cy)
...
for t = 1:num_region-1
    ...
    if num_region-t<5
        figure
        plot_segmentation_wo_voronoi(DT, sets_all{t}, cx, cy,lines(100) ,8,true)
