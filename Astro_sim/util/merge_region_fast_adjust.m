function [sets_all, log_like_all] = merge_region_fast_adjust(num_region, region_area, ...
    region_intensity, region_sets, adj_mat_region, region_num_cells, n, factor,adjust_indc)
