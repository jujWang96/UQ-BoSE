function [cx, cy, n, DT, E, cell_log_intensity, cell_area] = init_comp_adjust(X, bound_x, bound_y, instrument_factor,adjust_indc,count)
...
for i = 1:n
    ...
    if max_x>bound_x(2) || min_x<bound_x(1) || max_y>bound_y(2) || min_y<bound_y(1)
        ...
        if adjust_indc(i)== 1
           cell_area(i) = cell_area(i) *instrument_factor(i);
        end
