...
for seed = 1:B
    bootstrap_X_set_AIC = sim_fix_data_vor_fast(X,cell_area, n, DT,1,1,seed);
    ...
    bootstrap_X_set_BIC = sim_fix_data_vor_fast(X,cell_area, n, DT,1,1,seed);
...
%save('bootstrap_result_2300XMM_vor1.mat')