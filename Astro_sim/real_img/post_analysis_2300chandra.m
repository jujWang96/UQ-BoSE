...
load('bootstrap_result_2300chandra.mat')
load('model_select_result_2300chandra.mat')
imagename = 'NGC2300chandra_';
target_idx = 4;
...
make_eccentricity_plot([long_axis,short_axis],[long_all_axis;short_all_axis]',20,50, 'NGC2300',0.5)
