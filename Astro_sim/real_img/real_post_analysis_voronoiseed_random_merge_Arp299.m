...
%[glb_contour,glb_region_intensity,glb_selected,glb_min_BIC,seg_contour,seg_region_intensity,seg_selected,seg_min_BIC] = gSRG_random3_voronoiseeds(X,true,true, 'k',[],true,true,2,rand_step_num,seg_rep,full_rep,6,P,threshold);
%save('real_full_voronoiseed_random_Arp299_merge6.mat','X','glb_selected','seg_selected')