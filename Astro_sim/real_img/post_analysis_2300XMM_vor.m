...
load('bootstrap_result_2300XMM_vor_vk.mat')
load('model_select_result_2300XMM.mat')
load('flexible_model_select_result_2300XMM.mat')
...
imagename = '~/src/gsrg/Astro_sim/real_img/sim_results/NGC2300XMM_vor_vk_';
dataname = 'NGC2300XMM';
keep_offset=false;
