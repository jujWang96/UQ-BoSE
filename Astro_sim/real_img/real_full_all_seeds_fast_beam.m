...
region_sets = num2cell(1:length(valid));
...
[log_like_all_buffer, sets_all_buffer, sets_all, log_like_all,~,~,~] = merge_region_beam_search(num_region, ...
    cell_area(valid),cell_log_intensity(valid), region_sets, adj_mat(valid, valid), n,bw);
...
clear sets_all
filename = 'real_full_beam_all_seeds_result';
