clear
close all
%load('real_full_fast_result_2023_1_31_9_47_58.mat')
load('real_full_fast_result_2023_2_5_22_41_1')
addpath(genpath('~/Desktop/gsrg/Astro_sim'))
addpath(genpath('~/Desktop/gsrg/G-SRG'))
addpath(genpath('~/Desktop/gsrg/plot_util'))
filename = 'real_all_greedy_';
% plot the data
fig = figure;
scatter(X(:, 1), X(:, 2), 1,'k.')
axis image
...
saveas(fig, strcat(filename,'data'), 'png')
...
saveas(fig, strcat(filename,'log_intensity_in'), 'png')
...
saveas(fig, strcat(filename,'seeds'), 'png')
...
box on
min_white_margin(gca);
saveas(fig, strcat(filename,'segment_result'), 'png')
...
box on
min_white_margin(gca);
saveas(fig, strcat(filename,'region_stack'), 'png')
...
set(gca, 'fontsize', 14)
min_white_margin(gca);
saveas(fig, strcat(filename,'point_sources'), 'png')
...
set(gca, 'fontsize', 14);
min_white_margin(gca);
saveas(fig, strcat(filename,'segment_results_region'), 'png')
...
set(gca, 'fontsize', 12)
min_white_margin(gca);
saveas(fig, strcat(filename,'segment_result_points'), 'png')
