...
for seed = 1:B
    nexttile
    bootstrap_X_set_AIC = sim_fix_data_vor(X,1,1,seed);
    ...
    centx_poly_all_AIC(seed), centy_poly_all_AIC(seed), centx_fd_all_AIC(seed), centy_fd_all_AIC(seed)] = sim_fit_random_real_data_twoseg(bootstrap_X_set_AIC{1}, seed, true, P, threshold, ...
