...
xlabel('Adjust Flux',"linewidth",2)
...
calc_arcra = @(x) calc_arcsec(x,7040,21640.5,25160.5,0.05,2.80783,1);
calc_arcdec = @(x) calc_arcsec(x,7044.0,24321.5,27843.5,0.05,-4.02374,2);
