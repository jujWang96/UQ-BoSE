...
parfor seed = 1:T
    ...
    [metrics_random(:, seed), n_region_random(:, seed), merge_time_random(:,seed)] = sim4_random_gridonly(loc, radius, base_num_in_circle, factors, lambda, sample_factors, seed,gridsize,seedsize);
    
end
save(strcat('sim4_result_random_gridonly_gs',num2str(gridsize),'.mat'))
