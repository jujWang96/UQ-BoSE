function [metrics, n_region,merge_time] = sim4(loc, radius, base_num_in_circle, factors, lambda, sample_factors, seed,gridszie)
...
for i = 1:length(factors)
    ...
    for j = 1:length(sample_factors)
        ...
        [labeled_cells, pred_class_all, n_region(index),merge_time(index)] = sim_fit(X, factor, sample_factor, seed, false,gridszie);
