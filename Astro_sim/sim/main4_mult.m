...
fileID = fopen('circular_10sim_center.txt','w');
...
%writematrix(ratio_seg,'circular_10sim.txt','WriteMode','append')
%writematrix(area_seg,'circular_10sim.txt','WriteMode','append')
%writematrix(flux_seg,'circular_10sim.txt','WriteMode','append')
