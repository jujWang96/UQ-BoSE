function [labeled_cells, pred_class_all, n_region,rad] = sim_fit_fast_bulleye(X, seed, show_plot,gridsize,seedsize)
...
%do another greedy merge until two regions left
rad = 0;
...
if n_region==2
    ...
    [sets_all_post, log_like_all_post] = merge_region_fast(n_region, region_area, ...
        region_intensity, selected_nonempty, adj_mat_region, region_num_cells, n);
