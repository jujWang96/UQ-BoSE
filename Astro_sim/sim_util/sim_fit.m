function [labeled_cells, pred_class_all, n_region,merge_time] = sim_fit(X, factor, sample_factor, seed, show_plot,gridszie,seedsize)
...
[seeds, ~, seeds_pt, num_s, num_s_pt] = get_seeds_sim_local_max(0.1, 0.9, 0.1, 0.9,...
    gridszie, gridszie, seedsize, cell_log_intensity, cell_area, cx, cy, 2, 50, 5, invalid,adj_mat);
num = num_s+num_s_pt;
